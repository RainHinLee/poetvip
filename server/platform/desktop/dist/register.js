...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_App_vue__ = __webpack_require__(249);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0841d070_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_App_vue__ = __webpack_require__(250);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-0841d070"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0841d070_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_App_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0841d070", Component.options)
  } else {
    hotAPI.reload("data-v-0841d070", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    [
      _c("pv-page", { staticClass: "page1" }, [
        _c("header", [
          ...
          _vm._v(" "),
          _c("p", [
            _c("a", { attrs: { href: "/user/login" } }, [_vm._v("登陆")])
          ])
        ])
      ]),
      _vm._v(" "),
      _c("pv-page", { staticClass: "page2" }, [
        _c("article", { staticClass: "is-body" }, [
          _c("section", [
            _c("h3", [_vm._v("创建账户")]),
            _vm._v(" "),
            _c("ul", [
              _c("li", [
                ...
                _vm._v(" "),
                _c("a", { class: { "is-active": _vm.username.error } }, [
                  _vm._v("\n\t\t\t\t\t\t\t" + _vm._s(_vm.username.text) + " "),
                  _c("i", { staticClass: "iconfont icongantanhao-yuankuang" })
                ])
              ]),
              _vm._v(" "),
              _c("li", [
                ...
                _vm._v(" "),
                _c("a", { class: { "is-active": _vm.phone.error } }, [
                  _vm._v("\n\t\t\t\t\t\t\t" + _vm._s(_vm.phone.text) + " "),
                  _c("i", { staticClass: "iconfont icongantanhao-yuankuang" })
                ])
              ]),
              _vm._v(" "),
              _c("li", { staticStyle: { "padding-top": "5px" } }, [
                ...
                _c(
                  "a",
                  {
                    class: { "is-active": _vm.code.error },
                    staticStyle: { top: "-13px" }
                  },
                  [
                    _vm._v("\n\t\t\t\t\t\t\t" + _vm._s(_vm.code.text) + " "),
                    _c("i", { staticClass: "iconfont icongantanhao-yuankuang" })
                  ]
                ),
                _vm._v(" "),
                _c(
                  "p",
                  { staticClass: "send_code", on: { click: _vm.getCode } },
                  [
                    _vm.code.time > 0
                      ? [_vm._v(_vm._s(_vm.code.time) + "s")]
                      : [_vm._v("发送验证码")]
                  ],
                  2
                )
              ...
              _c("li", [
                _c("input", {
                  ...
                  attrs: { placeholder: "密码（英文或数字，不少于6位" },
                ...
                _vm._v(" "),
                _c("a", { class: { "is-active": _vm.password.error } }, [
                  _vm._v("\n\t\t\t\t\t\t\t" + _vm._s(_vm.password.text) + " "),
                  _c("i", { staticClass: "iconfont icongantanhao-yuankuang" })
                ])
              ])
            ]),
            _vm._v(" "),
            _c("p", { staticClass: "trembox" }, [
              _c(
                "time",
                {
                  class: { "is-active": _vm.isAgreeTerm },
                  on: {
                    click: function($event) {
                ...
                [_c("i", { staticClass: "iconfont iconcomplete-o" })]
              ),
              _vm._v(" "),
              _c("span", [
                _vm._v("\n\t\t\t\t\t\t我已阅读并接受"),
                _c("a", { attrs: { href: "/copyright", target: "_blank" } }, [
                  _vm._v("《版权声明》")
                ]),
                _vm._v("和"),
            ...
            _vm._v(" "),
            _c("p", { staticClass: "hasbox" }, [
              _vm._v("已有账户，"),
              _c("a", { attrs: { href: "/user/login" } }, [_vm._v("马上登陆")])
            ])
          ])
        ])
      ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0841d070", esExports)
  }
}
