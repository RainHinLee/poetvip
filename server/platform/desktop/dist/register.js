...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_31cb9745_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(279);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-31cb9745"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_App_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_31cb9745_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "desktop\\components\\register\\App.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-31cb9745", Component.options)
  } else {
    hotAPI.reload("data-v-31cb9745", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
exports.default = {
	...
	methods: {
		submit: function submit() {
			...
			_api2.default.customer.register(data).then(function (result) {
				var url = window.query.target || "/account"; //--注册成功后的网址
				document.location.href = url;
				_this.$toast("注册成功", "success");
			}).catch(function (err) {
			...
			switch (key) {
				...
				case "phone":
					...
					if (isPhone(this.phone.value)) {
						//--手机格式正确
						_api2.default.customer.findByPhone(this.phone.value).then(function (res) {
							//---检测手机是否注册
							var data = res._id ? { error: true, text: "手机已注册" } : { error: false, text: "" };
							Object.assign(_this3.phone, data);
						}).catch(function (err) {
							//--请求错误
							Object.assign(_this3.phone, { error: false, text: "" });
						});
					} else {
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("登陆")])])])]), _vm._v(" "), _c('pv-page', {
    staticClass: "page2"
  }, [_c('article', {
    staticClass: "is-body"
  }, [_c('section', [_c('h3', [_vm._v("创建账户")]), _vm._v(" "), _c('ul', [_c('li', [_c('input', {
    directives: [{
      name: "model",
    ...
    on: {
      "blur": [function($event) {
        return _vm.blur('username')
      }, function($event) {
        return _vm.$forceUpdate()
      }],
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.$set(_vm.username, "value", $event.target.value.trim())
      }
    }
  }), _vm._v(" "), _c('a', {
    class: {
      'is-active': _vm.username.error
    }
  }, [_vm._v("\n\t\t\t\t\t\t\t" + _vm._s(_vm.username.text) + " "), _c('i', {
  ...
  }, [(_vm.code.time > 0) ? [_vm._v(_vm._s(_vm.code.time) + "s")] : [_vm._v("发送验证码")]], 2)]), _vm._v(" "), _c('li', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model.trim",
    ...
    class: {
      'is-active': _vm.isAgreeTerm
    },
    on: {
      "click": function($event) {
        _vm.isAgreeTerm = !_vm.isAgreeTerm
      }
    }
  }, [_c('i', {
  ...
  }, [_vm._v("《版权声明》")]), _vm._v("和"), _c('a', {
    attrs: {
      "href": "/privacy",
      "target": "_blank"
    }
  }, [_vm._v("《隐私保护》")])])]), _vm._v(" "), _c('div', {
    staticClass: "btnbox"
  }, [_c('a', {
    class: {
  ...
  }, [_vm._v("\n\t\t\t\t\t\t" + _vm._s(_vm.loading.register ? "正在注册......" : "注册") + "\n\t\t\t\t\t")])]), _vm._v(" "), _c('p', {
    staticClass: "hasbox"
  }, [_vm._v("已有账户，"), _c('a', {
    attrs: {
      "href": "/user/login"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-31cb9745", module.exports)
  }
}
